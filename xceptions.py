...
for i in range(data.shape[0]):
    img_bgr_data = data[i,:,:,:]
    region_flag_r = ((abs(img_bgr_data[:,:,0]-158)<=64) & (abs(img_bgr_data[:,:,1]-103)<=61)&(abs(img_bgr_data[:,:,2]-168)<=72))
    nulei_flag_r = round(np.sum(region_flag_r)/(64*64),4)
    
    
    
    region_flag_b = ((abs(img_bgr_data[:,0,:]-206)<=35)&(abs(img_bgr_data[:,1,:]-196)<=44)&(abs(img_bgr_data[:,2,:]-190)<=46))
